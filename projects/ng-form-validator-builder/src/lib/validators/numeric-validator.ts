...
export class NumericValidator {
    ...
    public static lessThan(maxLength: number, errorMessage?: string): ValidatorFn {
        return (control: FormControl): ValidationErrors => {
            return new ValidationBuilder(control)
                .numeric
                .isValidNumber(errorMessage)
    ...
    public static lessThanOrEqual(maxLength: number, errorMessage?: string): ValidatorFn {
        return (control: FormControl): ValidationErrors => {
            return new ValidationBuilder(control)
                .numeric
                .isValidNumber(errorMessage)
    ...
    public static greaterThan(minLength: number, errorMessage?: string): ValidatorFn {
        return (control: FormControl): ValidationErrors => {
            return new ValidationBuilder(control)
                .numeric
                .isValidNumber(errorMessage)
    ...
    public static greaterThanOrEqual(minLength: number, errorMessage?: string): ValidatorFn {
        return (control: FormControl): ValidationErrors => {
            return new ValidationBuilder(control)
                .numeric
                .isValidNumber(errorMessage)
