...
export class NumericValidationBuilder implements IValidationBuilder {
    ...
    public isValidNumber(errorMessage?: string): NumericValidationBuilder {
        if (this.builder.ignore) { return this; }
    ...
    public lessThan(comparer: number, errorMessage?: string): NumericValidationBuilder {
        if (this.builder.ignore) { return this; }

        errorMessage = errorMessage || `Value needs to be less than ${comparer}`;
        if (!this.assertNumber()) { return this; }
    ...
    public lessThanOrEqualTo(comparer: number, errorMessage?: string): NumericValidationBuilder {
        if (this.builder.ignore) { return this; }

        errorMessage = errorMessage || `Value needs to be less than or equal to ${comparer}`;
    ...
    public greaterThan(comparer: number, errorMessage?: string): NumericValidationBuilder {
        if (this.builder.ignore) { return this; }
    ...
    public greaterThanOrEqualTo(comparer: number, errorMessage?: string): NumericValidationBuilder {
        if (this.builder.ignore) { return this; }

        errorMessage = errorMessage || `Value needs to be greater than or equal to ${comparer}`;
    ...
    public minValueAllowed(min: number, errorMessage?: string): NumericValidationBuilder {
        if (this.builder.ignore) { return this; }

        errorMessage = errorMessage || `Value needs to be greater than or equal to ${min}`;
    ...
    public maxValueAllowed(max: number, errorMessage?: string): NumericValidationBuilder {
        if (this.builder.ignore) { return this; }

        errorMessage = errorMessage || `Value needs to be less than or equal to ${max}`;
    ...
    ifTrue(callbackFn: (value: any) => boolean, errorKey: string, errorMessage: string): NumericValidationBuilder {
        this.builder.ifTrue(callbackFn, errorKey, errorMessage);
        return this;
    }

    ifFalse(callbackFn: (value: any) => boolean, errorKey: string, errorMessage: string): NumericValidationBuilder {
